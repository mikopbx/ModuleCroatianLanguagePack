...
namespace Modules\ModuleCroatianLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleCroatianLanguagePackController
 *
 * Controller for Croatian Language Pack module information page
 */
class ModuleCroatianLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleCroatianLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/hr-hr';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/hr';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-croatian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-croatian-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-croatian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-croatian-language-pack-sounds-index.js", true);
