...
namespace Modules\ModuleCroatianLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleCroatianLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * CroatianLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class CroatianLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-croatian-language-pack';
