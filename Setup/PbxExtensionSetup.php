...
namespace Modules\ModuleCroatianLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Croatian Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Croatian UI translations from Messages/hr/ directory
 * - Croatian voice prompts from Sounds/hr-hr/ directory
 *
 ...
 *
 * @package Modules\ModuleCroatianLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleCroatianLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Croatian packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Croatian Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Croatian Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Croatian Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Croatian Language Pack uninstalled successfully',
            LOG_INFO
        );
